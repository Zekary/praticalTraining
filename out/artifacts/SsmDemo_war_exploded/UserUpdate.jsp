                        ...
                        <form action="/SsmDemo/updateUser" method="post">
                            ...
                            <div class="form-group row">
                                <label for="colFormLabelSm"
                                       class="col-sm-2 col-form-label col-form-label-sm">用户名</label>
                                <div class="col-sm-10">
                                    <input type="text" name="username" class="form-control form-control-sm"
                                           id="colFormLabelSm"  value="${updateUser.username}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="idcard" class="form-control"
                                           id="CarFormLabelLg"  value="${updateUser.idcard}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" name="email" class="form-control"
                                           id="colFormLabelLg" value="${updateUser.email}"
                                           placeholder="col-form-label-lg">
                                </div>
                            </div>
                            <div class="form-group row">
