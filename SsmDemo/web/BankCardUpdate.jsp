    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">银行卡数据修改</h5>
                        ...
                        <%--                            --%>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select type="text" name="cardbank" class="form-control form-control-sm" id="colFormLabelSm">
                                        <c:forEach items="${banks}" var="bankItem">
                                            <option
                                                    <c:if test="${bankItem.id==updateBankCard.cardbank}">seleted</c:if>
                                                    value="${bankItem.id}">${bankItem.name}
                                            </option>
                                        </c:forEach>
                                    </select>
<%--                                    <input type="text" name="cardbank" class="form-control form-control-sm"--%>
<%--                                           id="colFormLabelSm"  value="${bankcard.cardbank}"--%>
<%--                                           placeholder="银行卡所属银行">--%>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select type="text" name="type"  class="form-control" id="colFormLabel">
                                        <option <c:if test="${updateBankCard.type==1}">seleted</c:if>
                                                value="1">借记卡
                                        </option>
                                        <option <c:if test="${updateBankCard.type==2}">seleted</c:if>
                                                value="2">信用卡
                                        </option>
                                    </select>
<%--                                    <input type="text" name="type"  value="${bankcard.type}"--%>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="cardnum" class="form-control"
                                           id="CarFormLabelLg"  value="${updateBankCard.cardnum}"
                                           placeholder="银行卡号">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="test" name="userid" class="form-control"
                                           id="colFormLabelLg" value="${updateBankCard.userid}"
                                           placeholder="用户id">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="test" name="balance" class="form-control"
                                           id="colFormbalance" value="${updateBankCard.balance}"
                                           placeholder="金额">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select type="test" name="defaultl" class="form-control" id="colFormdefaultl">
                                        <option <c:if test="${updateBankCard.defaultl==1}">seleted</c:if>
                                                value="1">默认
                                        </option>
                                        <option <c:if test="${updateBankCard.defaultl==2}">seleted</c:if>
                                                value="0">不默认
                                        </option>
                                    </select>
<%--                                    <input type="test" name="defaultl" class="form-control"--%>
<%--                                           id="colFormdefaultl" value="${bankcard.defaultl}"--%>
<%--                                           placeholder="1(是)/0(否)">--%>
                                </div>
                            </div>
