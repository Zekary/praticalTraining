                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <%--        items表示为数据源        var临时变量                --%>
                                <c:forEach items="${list}" var="bankcardItem">
                                    <tr>
                                        <th scope="row">${bankcardItem.id}</th>
                                        <td>${bankcardItem.bank.name}</td>
<%--                                        <td>${bankcardItem.type}</td>--%>
                                        <td>
                                            <c:if test="${bankcardItem.type==1}">
                                                借记卡
                                            </c:if>
                                            <c:if test="${bankcardItem.type==2}">
                                                信用卡
                                            </c:if>
                                        </td>
                                        <td>${bankcardItem.cardnum}</td>
                                        <td>${bankcardItem.user.username}</td>
                                        <td>${bankcardItem.balance}</td>
<%--                                        <td>${bankcardItem.defaultl}</td>--%>
                                        <td>
                                            <c:if test="${bankcardItem.defaultl==1}">
                                                默认
                                            </c:if>
                                            <c:if test="${bankcardItem.defaultl==2}">
                                                非默认
                                            </c:if>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="/SsmDemo/toUpdateBankCard?id=${bankcardItem.id}"><button class="dropdown-item" type="button">修改</button></a>
                                                    <a href="/SsmDemo/deleteBankCard?id=${bankcardItem.id}"><button class="dropdown-item" type="button">删除</button></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
