                    ...
                    <div class="card-body">
                        ...
                        <form action="/SsmDemo/updateBank" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" class="form-control form-control-sm"
                                           id="colFormLabelSm"  value="${updateBank.name}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="type"  value="${updateBank.type}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="assets" class="form-control"
                                           id="CarFormLabelLg"  value="${updateBank.assets}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="test" name="bankdesc" class="form-control"
                                           id="colFormLabelLg" value="${updateBank.bankdesc}"
                                           placeholder="col-form-label-lg">
                                </div>
                            </div>
                            <div class="form-group row">
